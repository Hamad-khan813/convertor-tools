...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${siteBaseUrl}/convert/tool/${page.slug}`,
    },
    openGraph: {
      title: page.title,
      description: page.description,
      url: `${siteBaseUrl}/convert/tool/${page.slug}`,
      type: "website",
    },
  };
}
...
export default function SpecialConverterPage({ params }: Props) {
  ...
  return (
    <div className="space-y-12">
      ...
      <section className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <h2 className="text-2xl font-semibold text-zinc-950 dark:text-white">Conversion guidance</h2>
        <p className="mt-3 text-sm leading-7 text-zinc-600 dark:text-zinc-400">
          This tool is designed to help you understand agricultural dosage, NPK blending, and nutrient planning. Use the related calculator conversions below for unit-based measurements.
        </p>
      </section>
      ...
      <section className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <h2 className="text-2xl font-semibold text-zinc-950 dark:text-white">Related agricultural conversions</h2>
