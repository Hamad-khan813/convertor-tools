...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[color:var(--card-border)] bg-[color:var(--footer-bg)] shadow-inner shadow-black/5 transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 border-t border-[color:var(--card-border)] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
